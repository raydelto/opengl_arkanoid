...
bool Arkanoid::OnUserCreate() 
{
    ...
    // Load the sprite
    sprTile = std::make_unique<olc::Sprite>("./images/tiles.png");

    // Load Fragment Sprite
    sprFragment = std::make_unique<olc::Sprite>("./images/fragment.png");
...
bool Arkanoid::OnUserUpdate(float fElapsedTime)
{
